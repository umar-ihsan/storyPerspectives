...
from huggingface_hub import InferenceClient  # Use Inference API instead of pipeline
...
# Function to fetch the article from MongoDB
...
# Function to fetch MBFC bias rewriting guidelines
...
# Function to rewrite the article using Hugging Face API
...
# API endpoint to rewrite an article
@app.post("/rewrite")
